...
library(ISOweek)
library(scales)
path <- "/Users/andrew/Desktop/Riff_Analytics_Internship/analyze-data/user_reports/Beth/"
```
...
suppressWarnings(print(g_w2))
suppressWarnings(print(g_m2))
```
...
suppressWarnings(print(g_w3))
suppressWarnings(print(g_m3))
```
...
suppressWarnings(print(g_w4))
suppressWarnings(print(g_m4))
```
...
suppressWarnings(print(g_w5))
suppressWarnings(print(g_m5))
```
...
suppressWarnings(print(g_w6))
suppressWarnings(print(g_m6))
```
...
suppressWarnings(print(g_w7))
suppressWarnings(print(g_m7))
```
...
suppressWarnings(print(g_w8))
suppressWarnings(print(g_m8))
```
...
suppressWarnings(print(g_w9))
suppressWarnings(print(g_m9))
```
...
g_m10 <- ggplot(monthoverall2, aes(x = time, y = SU_affirmations, color=with_top_collaborator)) +
     ...
     theme_minimal() + 
     scale_y_continuous(limits = c(0, 6))
suppressWarnings(print(g_w10))
suppressWarnings(print(g_m10))
```
...
g_m11 <- ggplot(monthoverall2, aes(x = time, y = SU_influences, color=with_top_collaborator) ) +
     ...
     theme_minimal() + 
     scale_y_continuous(limits = c(0, 6))
suppressWarnings(print(g_w11))
suppressWarnings(print(g_m11))
```
...
suppressWarnings(print(g_w12))
suppressWarnings(print(g_m12))
```
...
suppressWarnings(print(g_w13))
suppressWarnings(print(g_m13))
```
...
suppressWarnings(print(g_w14))
suppressWarnings(print(g_m14))
```
